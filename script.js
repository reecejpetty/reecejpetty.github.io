...
const modes = [
    {
        ...
        "lock": "Scroll",
        "keys": [
            new Key([new KeyPress("1", "1E", "0x00")]),
            new Key([new KeyPress("2", "1F", "0x00")]),
            new Key([new KeyPress("3", "20", "0x00")]),
            new Key([new KeyPress("4", "21", "0x00")]),
            new Key([new KeyPress("5", "22", "0x00")]),
            new Key([new KeyPress("6", "23", "0x00")]),
            new Key([new KeyPress("7", "24", "0x00")]),
            new Key([new KeyPress("8", "25", "0x00")]),
            new Key([new KeyPress("9", "26", "0x00")]),
            new Key([new KeyPress("0", "27", "0x00")]),
            new Key([new KeyPress("a", "04", "0x00")]),
            new Key([new KeyPress("b", "05", "0x00")]),
            new Key([new KeyPress("c", "06", "0x00")]),
            new Key([new KeyPress("d", "07", "0x00")]),
            new Key([new KeyPress("e", "08", "0x00")]),
            new Key([new KeyPress("f", "09", "0x00")]),
            new Key([new KeyPress("g", "0A", "0x00")]),
            new Key([new KeyPress("h", "0B", "0x00")]),
            new Key([new KeyPress("i", "0C", "0x00")]),
            new Key([new KeyPress("j", "0D", "0x00")]),
            new Key([new KeyPress("k", "0E", "0x00")]),
            new Key([new KeyPress("l", "0F", "0x00")]),
            new Key([new KeyPress("m", "10", "0x00")]),
            new Key([new KeyPress("n", "11", "0x00")]),
            new Key([new KeyPress("o", "12", "0x00")]),
            new Key([new KeyPress("p", "13", "0x00")]),
            new Key([new KeyPress("q", "14", "0x00")]),
            new Key([new KeyPress("r", "15", "0x00")]),
            new Key([new KeyPress("s", "16", "0x00")]),
            new Key([new KeyPress("t", "17", "0x00")])
        ]
    },
    {
        "mode": "2",
        ...
        "keys": [
            ...
            new Key([new KeyPress("g", "0A", "0x00")]),
            new Key([new KeyPress("a", "04", "0x00")]),
            new Key([new KeyPress("[UP_ARROW]", "52", "0x00")]),
            new Key([new KeyPress("[LEFT_ARROW]", "50", "0x00")]),
            new Key([new KeyPress("[NUM_5]", "5D", "0x00")]),
            new Key([new KeyPress(".", "37", "0x00")]),
            new Key([new KeyPress("f", "09", "0x00")]),
            new Key([new KeyPress("[ESC]", "29", "0x00")]),
            new Key([new KeyPress("[DEL]", "4C", "0x00")]),
            new Key([new KeyPress("[BACKSPACE]", "2A", "0x00")]),
            new Key([new KeyPress("[END]", "4D", "0x00")]),
            new Key([new KeyPress("[TAB]", "2B", "0x00")]),
            new Key([new KeyPress("[DOWN_ARROW]", "51", "0x00")]),
            new Key([new KeyPress("[RIGHT_ARROW]", "4F", "0x00")]),
            new Key([new KeyPress("[NUM_5]", "5D", "0x00")]),
            new Key([new KeyPress("0", "27", "0x00")]),
            new Key([new KeyPress("1", "1E", "0x00")]),
            new Key([new KeyPress("2", "1F", "0x00")]),
    ...
    },
    {
        ...
        "keys": [
            ...
            new Key([new KeyPress("a", "04", "0x00")]),
            new Key([new KeyPress("[DOWN_ARROW]", "51", "0x00")]),
            new Key([new KeyPress("[ENTER]", "28", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
    ...
    },
    {
        ...
        "keys": [
            ...
            new Key([new KeyPress("[NUM_-]", "56", "0x00")]),
            new Key([new KeyPress("[DOWN_ARROW]", "51", "0x00")]),
            new Key([new KeyPress("[LEFT_ARROW]", "50", "0x00")]),
            new Key([new KeyPress("[RIGHT_ARROW]", "4F", "0x00")]),
            new Key([new KeyPress("[SPACE]", "2C", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
            new Key([new KeyPress("", "00", "0x00")]),
            new Key([new KeyPress("[ENTER]", "28", "0x00")]),
...
function updateMode() {
    ...
    // If not mode 4, disable configure and active states of buttons
    if (modeValue != "4"){
        for (let i = 0; i < 30; i++) {
